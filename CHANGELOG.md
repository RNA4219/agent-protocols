...
- 0002 [docs/protocol.md](docs/protocol.md) と [docs/operations.md](docs/operations.md) を追加し、プロトコル仕様と運用ポリシーを分離
- 0003 [docs/implementation-prep.md](docs/implementation-prep.md) を追加し、schema / validation / orchestration / policy の実装準備を整理
...
- 0007 [docs/BIRDSEYE.md](docs/BIRDSEYE.md) と `docs/birdseye/*` を追加し、最小 Birdseye 索引を整備
